...
public class ManualOrderController {
    ...
    @Autowired
    GateTransportDetailsRepository gtdRepo;
    ...
    @RequestMapping(value="/manual/new",method=RequestMethod.GET)
    public String newManual(Model model){
    	
      //  model.addAttribute("slfs", sfRepo.findAll());
    	model.addAttribute("BulkOrder", new BulkOrder());   	
    	...
    	model.addAttribute("custmer", custmer);
    	
    	return "manualorder";        
    }
    
    @RequestMapping(value="/manual/new",method=RequestMethod.POST)
    public String newManual( @RequestParam String po_number, @RequestParam int customer_id,
    //public String newManual(@RequestParam String customer_name, @RequestParam Date created, @RequestParam String name, @RequestParam String po_number,
			Model model) {
